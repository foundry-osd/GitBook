...
PXE is not a native Foundry OSD media output. To use existing third-party PXE infrastructure, [deploy with PXE](pxe-deployment.md) by importing the boot image from a validated Foundry OSD ISO.
